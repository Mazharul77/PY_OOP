...
# Now Check Individual Object representing class:
# It utilizes for big project fast handling or fast understanding
...
# More Complex accessing of modules will bw discussed step by step
